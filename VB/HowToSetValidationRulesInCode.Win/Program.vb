...
Imports HowToSetValidationRulesInCode.Win
...
Public Class Program
    ...
    Public Shared Sub Main(ByVal arguments() As String)
        ...
        Dim _application As HowToSetValidationRulesInCodeWindowsFormsApplication = New HowToSetValidationRulesInCodeWindowsFormsApplication()
