namespace HowToSetValidationRulesInCode.Win {
	partial class HowToSetValidationRulesInCodeWindowsFormsApplication {
		/// <summary> 
		...
		private void InitializeComponent() {
			...
			this.module4 = new HowToSetValidationRulesInCode.Module.Win.HowToSetValidationRulesInCodeWindowsFormsModule();
			...
			// sqlConnection1
			// 
			this.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=HowToSetValidationRulesInCode;Integrated Security=SSPI;Pooling=false";
			this.sqlConnection1.FireInfoMessageEventOnUserErrors = false;
			// 
			// HowToSetValidationRulesInCodeWindowsFormsApplication
			// 
			...
			this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.HowToSetValidationRulesInCodeWindowsFormsApplication_DatabaseVersionMismatch);
		...
		private HowToSetValidationRulesInCode.Module.Win.HowToSetValidationRulesInCodeWindowsFormsModule module4;
